...
that provider. Generalized from `skills/daily-task-manager/SKILL.md:11-58`.
...
(`skills/daily-task-manager/SKILL.md:14`). Run outcomes: `CONFLICT` (divergent
...
requirement for remove (`skills/daily-task-manager/SKILL.md:19`); and the
