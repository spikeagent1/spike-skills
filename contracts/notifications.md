...
- **mode** ∈ `immediate`, `held`, `summarized`, `silent`, `failure-only` (`skills/cron-scheduler/SKILL.md:78`).
...
notification held (`skills/cron-scheduler/SKILL.md:90`). Held messages are
...
(`skills/cron-scheduler/SKILL.md:92`).
