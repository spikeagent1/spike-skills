...
12. Append one `effects` record per mutating effect — operation key, target, effect state, readback, rollback handle (M7) — and close on what is still open: the consent not yet asked, the moderator not yet named, the surface not yet authorized.
