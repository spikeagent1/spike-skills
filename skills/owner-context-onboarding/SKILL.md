...
|---|---|---|
| Asking again about a preference the message just stated | The owner has answered, and re-asking wastes the turn and reads as not listening | Put it on the matrix as `confirmed`, `owner-stated`, this turn, and put the question on the highest-value row still `unknown` |
